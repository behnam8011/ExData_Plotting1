...
par(mfrow = c(2,2))
plot(d$Date_Time, d$Global_active_power, type = "l", ylab = "Global Active Power (killowatts)")
...
legend("topright", legend = c("Sub_metering_1","Sub_metering_2","Sub_metering_3"), col = c(1,2,4), lty = c(1,1,1),bty = "n" , box.lty = 0)
plot(d$Date_Time, d$Global_reactive_power, type = "l",ylab = "Global_reactive_power" , xlab = "datetime")
